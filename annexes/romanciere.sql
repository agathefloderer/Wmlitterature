...
INSERT INTO "portrait" VALUES (1,'https://upload.wikimedia.org/wikipedia/commons/f/fb/Claire_de_Duras.jpg',NULL,NULL,'1840',NULL,NULL,2);
INSERT INTO "portrait" VALUES (3,'https://upload.wikimedia.org/wikipedia/commons/e/ee/George_Sand.PNG','CHARPENTIER','Auguste','1838',NULL,'Musée de la Vie romantique - Paris',3);
INSERT INTO "portrait" VALUES (4,'https://upload.wikimedia.org/wikipedia/commons/d/d1/Th%C3%A9r%C3%A8se_Bentzon.jpg',NULL,NULL,'1905','Peinture',NULL,4);
INSERT INTO "portrait" VALUES (5,'https://upload.wikimedia.org/wikipedia/commons/b/b4/Solange_Dudevant-_Cl%C3%A9singer_%281828-1899%29.jpg','CLESINGER','Auguste','1849',NULL,'Musée de la vie romantique - Paris',5);
INSERT INTO "portrait" VALUES (6,'https://upload.wikimedia.org/wikipedia/commons/9/95/Eug%C3%A9nie_Foa_%281796-1852%29.png','BECQUET','',NULL,'Gravure','Bibliothèque de Bordeaux',7);
INSERT INTO "portrait" VALUES (7,'https://upload.wikimedia.org/wikipedia/commons/1/15/Marie-Louise_Gagneur.png','PETIT','Pierre','1872','Photographie','Gallica',8);
INSERT INTO "portrait" VALUES (8,'https://upload.wikimedia.org/wikipedia/commons/b/b1/Jane_de_La_Vaud%C3%A8re.jpg','LAUDA','E. de','1902',NULL,NULL,10);
INSERT INTO "portrait" VALUES (9,'https://upload.wikimedia.org/wikipedia/commons/b/b0/Raoul_de_Navery_BNF_Gallica.jpg',NULL,NULL,'1875','Photographie','Bibliothèque nationale de France',12);
INSERT INTO "portrait" VALUES (10,'https://upload.wikimedia.org/wikipedia/commons/2/25/Olga_de_Pitray-S%C3%A9gur.jpg','BARRIAS','Félix Joseph','1859',NULL,NULL,14);
INSERT INTO "portrait" VALUES (11,'https://upload.wikimedia.org/wikipedia/commons/d/d6/Jean-Baptiste_Fran%C3%A7ois_Desoria_-_Portrait_de_Constance_Pipelet.jpg','DESORIA','Jean Baptiste François','1797','Peinture',NULL,17);
COMMIT;
